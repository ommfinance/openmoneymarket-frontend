...
export declare function sendIrc2Token(magic: any, address: string, scoreAddress: string, amount: number, IconBuilder: any, IconAmount: any, IconConverter: any, magicUserMetadata: MagicUserMetadata | undefined): Promise<string>;
