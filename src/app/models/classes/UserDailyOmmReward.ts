...
export class UserDailyOmmReward {
  ...
  constructor(OmmIusdc: BigNumber, OmmUsds: BigNumber, OmmSicx: BigNumber, bOMM: BigNumber, dICX: BigNumber,
              dIUSDC: BigNumber, dOMM: BigNumber, dUSDS: BigNumber, dbnUSD: BigNumber, oICX: BigNumber,
